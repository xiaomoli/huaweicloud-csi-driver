...
PKG=github.com/xiaomoli/huaweicloud-csi-driver
...
sfs-image:sfs
	...
	docker build cmd/sfs-csi-plugin -t liyongboat/sfs-csi-plugin:latest
...
sfsturbo-image:sfsturbo
	...
	docker build cmd/sfsturbo-csi-plugin -t liyongboat/sfsturbo-csi-plugin:latest
